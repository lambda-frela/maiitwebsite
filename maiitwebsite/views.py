...
def members(request):
	...
	partners = Member.objects.filter(member_type='par')
	
	return render_to_response(template_name, { "team_list":team, "partners_list":partners }, context_instance=RequestContext(request))
